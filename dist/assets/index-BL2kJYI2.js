...
`)+`
`+d);const b=A+m+a,S=A+d+o,F=Xu(s,s.VERTEX_SHADER,b),L=Xu(s,s.FRAGMENT_SHADER,S);s.attachShader(x,F),s.attachShader(x,L),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function P(R){if(n.debug.checkShaderErrors){const I=s.getProgramInfoLog(x).trim(),z=s.getShaderInfoLog(F).trim(),Z=s.getShaderInfoLog(L).trim();let nt=!0,$=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(nt=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,F,L);else{const tt=qu(s,F,"vertex"),V=qu(s,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
