...
const steps = [
  {
    icon: '🌲', title: '欢迎来到黑暗森林',
    desc: '你正站在森林的中心。四周一片漆黑，只能隐约看到树木的轮廓。奶蛙就藏在这片森林的某个角落...'
  },
  {
    icon: '👂', title: '用耳朵来寻找',
    desc: '奶蛙会不断发出笑声。转动手机或移动鼠标，仔细听笑声传来的方向。戴上耳机可以获得最精准的3D空间音效。'
  },
  {
    icon: '🎯', title: '对准声音的方向',
    desc: '听到声音后，将屏幕中央的准星对准声音传来的方向。你无法看到奶蛙——只能依靠听觉来判断它的位置。'
  },
  {
    icon: '🔦', title: '打开手电筒',
    desc: '当你确定奶蛙就在那个方向时，点击底部的手电筒按钮（或按空格键）。照中奶蛙它会暂时消失，并在新的位置重生。'
  },
  {
    icon: '⏱️', title: '坚持60秒',
    desc: '奶蛙会一步步向你靠近。你需要在黑暗中坚持60秒。心跳声会随奶蛙接近而加快——那是你唯一的警示。被奶蛙碰到，游戏就结束了。'
  }
]
